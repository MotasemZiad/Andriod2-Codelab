package com.motasem.ziad.lab6webservice.adapter
...
import com.motasem.ziad.lab6webservice.R
...
class SocialAdapter(val context: Context, val list: ArrayList<SocialData>, val click: onClick) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflate = LayoutInflater.from(context).inflate(R.layout.social_item, parent, false)
